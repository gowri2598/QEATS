...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(@Valid
    ...
    GetRestaurantsResponse getRestaurantsResponse;
      ...
      //CHECKSTYLE:ON
      //System.out.println("size of restaurants:"+getRestaurantsResponse.getRestaurants().size());//200
      // System.out.println("The response  is "+getRestaurantsResponse.getRestaurants());
      //index based access is not possible in mongo table
 
      List<Restaurant> modifiedRestaurantsResponse = getRestaurantsResponse.getRestaurants().
      ...
      getRestaurantsResponse.setRestaurants(modifiedRestaurantsResponse);
